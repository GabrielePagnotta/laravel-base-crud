@if ($paginator->hasPages())
    <nav role="navigation bg-black" aria-label="Pagination Navigation" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden">
            @if ($paginator->onFirstPage())
                <span class="relative  text-black-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md">
